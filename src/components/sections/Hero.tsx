  ...
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="relative z-10 flex flex-col items-center text-center px-6 pt-40 max-w-5xl mx-auto"
      >
        <motion.h1
          variants={line}
          className="font-serif font-light text-[clamp(42px,6.4vw,78px)] leading-[1.04] tracking-[-1px] text-black mb-6"
        >
          A dedicated guide for
          <br />
          every buyer
        </motion.h1>
        <motion.p variants={line} className="text-[17px] text-[#3F3F46] mb-8">
      ...
      <div className="relative w-full -mt-4" style={{ height: 560 }}>
      ...
      <motion.div
        ...
        className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 w-[min(420px,92vw)]"
      >
        <div className="flex items-center gap-3 bg-white/90 backdrop-blur-xl border border-[#E4E4E1] rounded-full pl-5 pr-2 py-2 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.25)]">
          <input
            type="text"
            placeholder="Ask me anything..."
            className="focus-accent rounded-full flex-1 min-w-0 bg-transparent text-sm text-black placeholder:text-[#A1A1AA] outline-none"
          />
          <button
            aria-label="Send"
            className="cta-lift shrink-0 w-9 h-9 rounded-full bg-[#F2F1ED] hover:bg-[#E4E4E1] flex items-center justify-center"
          >
