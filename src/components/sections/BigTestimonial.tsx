      ...
      <Reveal className="max-w-[1232px] mx-auto px-4 sm:px-6 md:px-8 pt-8 sm:pt-12 md:pt-16 pb-6 sm:pb-10 md:pb-14">
        ...
        <AnimatePresence mode="wait">
          <motion.blockquote
            ...
            className="font-serif text-[24px] sm:text-[32px] md:text-[40px] leading-[1.12] tracking-tight text-black mb-8 sm:mb-10 max-w-5xl"
          >
            {t.quote}
          </motion.blockquote>
        </AnimatePresence>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 sm:gap-4">
          <div className="flex items-center gap-3">
            <div className="w-8 sm:w-9 h-8 sm:h-9 rounded-full bg-[#E8E8E8] overflow-hidden shrink-0 flex items-center justify-center">
            ...
            <div>
              <p className="text-[12px] sm:text-[13px] font-semibold text-black">{t.name}</p>
              <p className="text-[12px] sm:text-[13px] text-[#52525B]">{t.role}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="w-8 h-8 rounded-full border border-[#E4E4E1] flex items-center justify-center hover:bg-[#F2F1ED] transition-colors min-h-[44px] min-w-[44px]"
            >
